...
class ClientSidePetSitterReviews extends StatefulWidget {
  const ClientSidePetSitterReviews({Key? key}) : super(key: key);

  @override
  _ClientSidePetSitterReviewsState createState() =>
      _ClientSidePetSitterReviewsState();
}

class _ClientSidePetSitterReviewsState
    extends State<ClientSidePetSitterReviews> {
  @override
  ...
  _getreview() {
    return Column(
      children: [
        ...
        //List of reviews
        RawScrollbar(
          thumbColor: const Color.fromRGBO(70, 209, 184, 1),
          thickness: 4.w,
          child: CustomContainer(
            containerWidth: 303.w,
            containerHeight: 352.h,
            containerRadius: BorderRadius.circular(8.r),
            containerBorder: Border.all(
                color: const Color.fromRGBO(226, 226, 226, 1), width: 0.8.h),
